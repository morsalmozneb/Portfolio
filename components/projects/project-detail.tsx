...
/* ─── Content panels — each with a completely different animation ── */

/* OVERVIEW: Characters rain down from above, word by word */
function ContentOverview({ project }: { project: typeof projects[0] }) {
  ...
  return (
    ...
    >
      <div style={{ fontSize: "6rem", lineHeight: 0.6, color: "rgba(140,145,247,0.1)", fontWeight: 900, marginBottom: 20, userSelect: "none", fontFamily: "serif" }}>"</div>
      <p style={{ fontSize: "clamp(0.95rem, 1.8vw, 1.05rem)", lineHeight: 2.1, color: "rgba(228,228,228,0.65)", maxWidth: 560 }}>
        {words.map((w, i) => (
          <motion.span key={i}
...
/* PROCESS: Items slam in from alternating left/right with elastic bounce */
          ...
          >
            ...
            <div style={{ flexShrink: 0, display: "flex", flexDirection: "column", alignItems: "center" }}>
              <motion.div
                ...
                style={{
                  width: 7, height: 7, borderRadius: "50%", background: "#8C91F7",
                  boxShadow: "0 0 12px rgba(140,145,247,0.7)", marginTop: 7,
                }}
              />
...
/* RESPONSIBILITIES: Each item peels up from the bottom with stagger + blur */
...
/* TOOLS: Tags burst from center — scale + rotation explosion outward */
...
/* ─── Nav item ─────────────────────────────────────────────────── */
function NavItem({
  section, index, isActive, isInView, onClick,
}: {
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: "0 0 12px rgba(140,145,247,0.8)",
        }}
      />
    ...
    <section className="relative py-16 overflow-hidden" ref={ref}>
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 style={{ fontSize: "clamp(2rem, 4.5vw, 3.2rem)", fontWeight: 800, color: "#E4E4E4", lineHeight: 1.1 }}>
            {project.title}
          </h2>
        </motion.div>

        {/* Two-column layout */}
        <div style={{ display: "grid", gridTemplateColumns: "200px 1fr", gap: "0 64px", alignItems: "start" }}>
          ...
          {/* ── RIGHT: content ── */}
          <div style={{ minHeight: 320, paddingTop: 8, paddingBottom: 32, position: "relative" }}>
            {/* Top glowing rule */}
            <motion.div
              initial={{ scaleX: 0 }}
