                ...
                <div className="w-full max-w-[1080px] mx-auto px-6 lg:px-12 pt-12 pb-16 lg:pb-20">
                              ...
                              key={i}
                                                          ...
                                                          <motion.div
                                                                          ...
                                                                          variants={riseIn}
                                                                        >
                                                                        <SparkleButton href="/projects" className="w-full sm:w-auto justify-center">View Projects</SparkleButton>SparkleButton>
                                                                        <SparkleButton href="mailto:morsalehmozneb@gmail.com" external className="w-full sm:w-auto justify-center">Email Me</SparkleButton>SparkleButton>
                                                          </motion.div>motion.div>
                                              </div>div>
